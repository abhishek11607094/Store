        ...
        <div>
            ...
            <div class="container">
                <div class="jumbotron">
                    ...
                    <p>We have the best Meals, Fruits and Sweets for you. No need to hunt around, we have all in one place.</p>
                </div>
            </div>
			<h1><center>Meals</center></h1>
            <div class="container">
                <div class="row">
                    <div class="col-md-3 col-sm-6">
                        <div class="thumbnail">
                            <a href="cart.php">
                                <img src="img/food1.jpg" alt="Special Thali">
                            </a>
                            <center>
                                <div class="caption">
                                    <h3>Special Thali</h3>
                    ...
                    <div class="col-md-3 col-sm-6">
                        <div class="thumbnail">
                            <a href="cart.php">
                                <img src="img/protein.jpg" alt="Protein Thali" width="142" height="90">
                            </a>
                            <center>
                                <div class="caption">
                                    <h3>Protein Thali</h3>
                    ...
                    <div class="col-md-3 col-sm-6">
                        <div class="thumbnail">
                            <a href="cart.php">
                                <img src="img/normal.jpg" alt="Normal Thali" width="142" height="90">
                            </a>
                            <center>
                                <div class="caption">
                                    <h3>Normal Thali</h3>
                    ...
                    <div class="col-md-3 col-sm-6">
                        <div class="thumbnail">
                            <a href="cart.php">
                                <img src="img/parantha.jpg" alt="Parantha Thali">
                            </a>
                            <center>
                                <div class="caption">
                                    <h3>Parantha Thali</h3>
                                    <p>Price: Rs. 40.00</p>
                                    <?php if(!isset($_SESSION['email'])){  ?>
                                        <p><a href="login.php" role="button" class="btn btn-primary btn-block">Buy Now</a></p>
                                        <?php
                ...
                <div class="row">
                    <div class="col-md-3 col-sm-6">
                        <div class="thumbnail">
                            <a href="cart.php">
                                <img src="img/fruits.jpg" alt="Fruit Salad" width="160" height="90" >
                            </a>
                            <center>
                                <div class="caption">
                                    <h3>Fruit Salad</h3>
                    ...
                    <div class="col-md-3 col-sm-6">
                        <div class="thumbnail">
                            <a href="cart.php">
                                <img src="img/banana.jpg" alt="Banana Shake"  width="201" height="90">
                            </a>
                            <center>
                                <div class="caption">
                                    <h3>Banana Shake</h3>
                    ...
                    <div class="col-md-3 col-sm-6">
                        <div class="thumbnail">
                            <a href="cart.php">
                                <img src="img/mixjuice.jpg" alt="Mix Fruit Juice" width="201" height="90">
                            </a>
                            <center>
                                <div class="caption">
                    ...
                    <div class="col-md-3 col-sm-6">
                        <div class="thumbnail">
                            <a href="cart.php">
                                <img src="img/chocolatemilkshake.jpg" alt="Chocolate Milkshake" width="155" height="90">
                            </a>
                            <center>
                                <div class="caption">
				...
				<h1><center>Sweets</center></h1>
                <div class="row">
                    <div class="col-md-3 col-sm-6">
                        <div class="thumbnail">
                            <a href="cart.php">
                                <img src="img/lassi.jpg" alt="Lassi" width="190" height="90">
                            </a>
                            <center>
                                <div class="caption">
                                    <h3>Lassi</h3>
                    ...
                    <div class="col-md-3 col-sm-6">
                        <div class="thumbnail">
                            <a href="cart.php">
                                <img src="img/gulab.jpg" alt="Gulab Jamun" width="145" height="90">
                            </a>
                            <center>
                                <div class="caption">
                                    <h3>Gulab Jamun</h3>
                    ...
                    <div class="col-md-3 col-sm-6">
                        <div class="thumbnail">
                            <a href="cart.php">
                                <img src="img/sweet.jpg" alt="Rasgulla" width="145" height="90">
                            </a>
                            <center>
                                <div class="caption">
                                    <h3>Rasgulla</h3>
                    ...
                    <div class="col-md-3 col-sm-6">
                        <div class="thumbnail">
                            <a href="cart.php">
                                <img src="img/barfi.jpg" alt="Barfi" width="195" height="90">
                            </a>
                            <center>
                                <div class="caption">
                                    <h3>Barfi</h3>
